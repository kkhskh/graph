...
# ---------------------------------------------------------------------------
# Part of the historical “legacy” suite.  These tests are only executed in
# the nightly CI job so day-to-day PR runs stay fast.  Mark the entire module
# accordingly so pytest can include/exclude via “-m legacy”.
# ---------------------------------------------------------------------------
...
class TestServiceMonitor(unittest.TestCase):
    ...
    def test_get_service_status_unknown(self):
        with self.assertRaises(ValueError):
            self.monitor.get_service_status("service_x")
