"""Legacy shim so that `import graph_heal.graph_heal` resolves to the root package.
This file lives in the *nested* legacy tree (graph-heal/graph_heal/) that ends
up on PYTHONPATH during CI.  We simply re-export the already-imported root
package instance so there is exactly one canonical copy.
"""

from importlib import import_module as _imp, sys as _s
_s.modules[__name__] = _imp("graph_heal")
